...
var selectAll=document.getElementById("selectAll");
		...
		/*$(function(){
       	 ...
       	 $("tr:even").css("background-color","pink").css("color","white");
       	 $("tr:odd").css("background-color","silver").css("color","white");;
...
<body background="imgs/3.jpg">
	 <div class="container">
		<table align="center" width="600px" height="200px" border="1px" class="table"
			...
			<td><input type="checkbox" name="ids" value="${s.id}"></td>
				...
				<!--  <td><input type="reset" value="删除" /></td>-->
					<td><a href='Userservlet?action=showoneUser&id=${s.id }'>${s.id } </a></td>	
			</tr>
			</c:forEach>
		...
		<table align="center" >
			<tr align="center" >
			<td><h3>没有找到指定用户？您可以点击这里</h3><button class="btn btn-sm" id="adduser"><span class="ui-icon ui-icon-circle-plus">
				</span><a href="addUser.jsp">添加用户</a></button></p></td>
